...
\nsection{Employment}
  ...
  \entry{November 2012 - \newline Present}
        {PhD Researcher \newline}
        {In my current position, I conduct research and perform teaching duties, including Bachelor and Master's level courses, and student supervision.
        }
%  \entry{January 2012 - \newline June 2012 }
...
\nsection{Skills}
  ...
  \entryni{Languages}
          {Fluent in Norwegian, German and English. \newline
           High level Dutch. Beginners Spanish and French.
          }
...
\nsection{Publications}
  ...
  \entryni{Journal \newline publications}
        {
         ...
         \begin{enumerate}[label={[\arabic*]},nosep]
           ...
           \item (In press) \bibentry{pelkmans2016c2h2}
  ...
  \entryni{In the works}
       {
       \begin{enumerate}[label={[\arabic*]},nosep]
          \addtocounter{enumi}{3}
          \item{\textit{Schizophyllum commune} has an extensive and functional alternative splicing repertoire}
          \item{Homokaryon specific expression in \textit{Agaricus bisporus} affects core functionality}
          \item{Understanding the evolution of antibiotic resistance in \textit{Mycobacterium tuberculosis} strains from Southern-India from Whole Genome Sequencing} \vspace*{-\baselineskip}
       \end{enumerate}
       }
