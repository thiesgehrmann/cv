...
\nsection{Personal profile}
  ...
  Currently, I am a Postdoc in the department of Molecular Epidemiology at the Leiden University Medical Centre, working on translational research of healthy ageing in familial genetic studies, and longitudinal intervention data.
  ...
  In this position, I am a bioinformatician, a field which, through the constant evolution of techniques available in biology, must constantly adapt by developing and applying novel methods and methodology.
  ...
  I am excited to be part of a field in which my knowledge and competences are constantly challenged, humbled and developed.
  The distinction between bioinformatician and biologist is deteriorating, and increasingly, it is biological questions that drive me.
  Beyond the technical aspects, I am interested in the broader social consequences of the methods, technologies and results which we as a scientific community produce. 
...
\nsection{Employment}
  ...
  \entry{January 2012 - \newline June 2012 }
        ...
        {Created and graded coursework, collected datasets for course use, and assisted students.
        }
...
\nsection{Skills}
  ...
  \entryni{Analytical}
          {Machine learning and statistics; \textit{"Data Science"}. \newline
          	...
          	Transcriptomic analysis (Differential expression, Alternative splicing, Variant calling, eQTL analysis, Time-series analysis). \newline
          	Epigenetic analysis (Methylation), and Metabolomic data analysis.
          }

  \entryni{Technical}
           {Python, Scala, C/C++, Java, Shell, Matlab, R, waiting for an excuse to learn Julia.\newline
           ...
           Experience with schedulers (SLURM, PDB) and version control software, (Git, Gitlab, SVN).\newline
           Experienced with Unix environments (Linux, MacOS).
           }
  \entryni{Languages}
          {Native speaker, English, Norwegian and German.
          	High level Dutch (Have taught courses in dutch). Beginners French.
          }
...
\nsection{Teaching}
  ...
  \entry{MSc Courses}{\textit{Frontiers of Science - Short Research Project}}
		{ \newline {\normalfont Teaching assistant. Fall 2019, and 2020 at Leiden University Medical Center. } }
  ...
  \entry{}{\textit{Clinical Research in Practice}}
		{ \newline { \normalfont Lecturer. Fall 2019, and 2020 at Leiden University Medical Center.} }
...
\entryni{Under Review}
{
	...
	\begin{enumerate}[label={[\arabic*]},nosep]
		...
		\item {Annick Lang, Thies Gehrmann, Nils Cronberg. Genetic diversity in bryophyte population with facultative nannandry (\textit{Under review in Frontiers in Plant science}) }

	\end{enumerate}
}

\entryni{In Preparation}
{
		\vspace*{-\baselineskip}
	\begin{enumerate}[label={[\arabic*]},nosep]
		\addtocounter{enumi}{13}
		\item {A combined lifestyle intervention induces a sensitization of the blood transcriptomic response to a nutrient challenge (\textit{In Preparation}) } \newline
		\item {Multi-tissue Transcriptomic and Metabolomic effects due to a combined lifestyle intervention.  (\textit{In Preparation}) } \newline
		\item {Metabolic predictiors for the health response to a combined lifestyle intervention. (\textit{In Preparation}) } \newline
		\item {Characterization of genetic variants in RAS/MEK/ERK Pathway in exceptionally long-lived Dutch families (\textit{In Preparation}) } \newline
		\item {Characterization of genetic variants in Linkage regions identified in exceptionally long-lived Dutch families (\textit{In Preparation}) } 
		...
		%\item {Antonis Somarakis, Manolis Fragkiadakis, Marios Kefalas, Stelios Paraschiakos, Michaelis Vrachasotakis, Thies Gehrmann. On the global prediction of land grabbing risk.  (\textit{In progress}) } \newline
...
{International Student Network (Leiden) 2013-2020. Theatre set construction and management. (Performances of summer and winter of 2020 cancelled due to COVID-19).\newline
...
\entryni{Hackathons}{Hackathon for Good 2019, The Hague: \href{https://www.hackathonforgood.org/translators-without-borders}{Translators Without Borders challenge}\newline
	Hackathon for Good 2018, The Hague: \href{https://www.hackathonforgood.org/v1-asser-institute-2018}{Asser Land-grabbing challenge}}
...
%          }
  \entryni{Hobbies}
         {Thies regularly enjoys Catamaran/Dinghy sailing (Laser, 420, Hobie16), Track \& Field (Running \& Throwing), Climbing/Bouldering, and Swimming. On holidays he frequently goes skiing and hiking. Theatre production and acting. Arboriculture and arborist climbing techniques. From seed-polyculture vegetable gardening. Sourdough bread baking. Guitar. Reading.}
...
%         \newline}
\entry{Erik van den Akker}
{Assistant Professor at the Leiden Computational Biology Center, Leiden University Medical Center \newline}
{\href{mailto:E.B.van_den_Akker@lumc.nl}{E.B.van\_den\_Akker@lumc.nl} \newline
	Supervisor, Bioinformatics. \newline}
...
\entry{Eline P. Slagboom}
{Group leader of the Molecular Epidemiology group, Leiden University Medical Center \newline}
{\href{mailto:p.slagboom@lumc.nl}{p.slagboom@lumc.nl} \newline
