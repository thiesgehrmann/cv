...
\nsection{Personal profile}
  ...
  The distinction between bioinformatician and biologist is degrading, and increasingly, it is biological questions that drive me.
  Beyond the technical aspects, I am interested in the broader social consequences of the methods and technologies which we as a scientific community develop and use. 
...
\entryni{In Progress}
{
	...
	\begin{enumerate}[label={[\arabic*]},nosep]
		...
		\item {Multi-tissue Transcriptomic and Metabolomic effects due to a combined lifestyle intervention.  (\textit{In progress}) } \newline
		\item {Metabolic predictiors for the health response to a combined lifestyle intervention. (\textit{In progress}) } \newline
...
{International Student Network (Leiden) 2013-2020. Set construction and management.\newline
