...
\nsection{Skills}
  ...
  \entryni{Technical Skills}
          {Python, Scala, C/C++, Java, Shell, Matlab, R\newline
           ...
           Machine learning, statistical genetics, comparative genomics, transcriptomic and metabolomic analysis and algorithm development.
...
\nsection{Student Supervision}
  ...
  \entry{Myrthe de Haan}{B.Sc student 2019-2020\newline}
           {Using the drug-gene interactome to predict intervention-mimicing drugs.\newline}
...
\entryni{In Progress}
{
	\begin{enumerate}[label={[\arabic*]},nosep]
		...
		\item {Lifestyle Intervention sensitizes the pro-homeostasis blood transcriptomic response to nutrient intake (\textit{In progress}) } \newline
