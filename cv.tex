...
\nsection{Education}
  ...
  \entry{2012-Present}
        ...
        {PhD in Bioinformatics. \newline
         \textit{Genetic and Transcriptomic Variation in Fungi}.
         \newline}
...
\nsection{Supervision}
  ...
  \entry{Jet Beekwilder}{Bsc Student 2017-2018\newline}
        {Nanopore sequencing of a \textit{Cryptococcous neoformans} Hybrid pathogen}
  ...
  \entry{Nina Terpstra}{Msc Student 2016\newline}
        {Differential expression of DMD gene in single cell expression measurements of the brain}
