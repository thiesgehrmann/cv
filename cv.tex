...
\nsection{Skills}
  ...
  \entryni{Technical Skills}
          {Analysis of Sanger, NGS and long-sequencing data (genomic, transcriptomic, epigenomic). \newline
          	Genetic/Genomic analysis (Genome assembly, Linkage analysis, *-WAS \& *-QTL, Phylogenetic analysis, variant calling) \newline
          	Transcriptomic analysis (Differential expression, alternative splicing, variant calling, timeseries analysis). \newline
           ...
           Vector image manipulation (Inkscape, Affinity Designer). \newline
